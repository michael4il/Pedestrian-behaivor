...
if __name__ == '__main__':
    ...
    with open(Path(args.video).with_suffix('.npy'), 'wb') as f:
        np.save(f, all_poses)
   

#file 1 - saves the poses from the demo into a different file
#file 2 - reads the poses and applies heurisitics.